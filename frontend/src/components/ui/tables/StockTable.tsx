      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Tamanho</th>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Cor</th>
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Cód Int</th>
          </tr>
        </thead>
        <tbody className="bg-white divide-y divide-gray-200">
          {props.data.map((e) => (
            <tr key={e.productId} className="hover:bg-gray-50 transition-colors duration-150">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 bg-gray-50 text-center">
                <span className="inline-block px-2 py-1 rounded-md bg-gray-100">
                  {e.productSize}
                </span>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{new Date(e.productData).toLocaleDateString()}</td>
